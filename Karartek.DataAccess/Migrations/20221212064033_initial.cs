        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courts_Commissions_CommissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Judgments_Commissions_CommissionId",
                        column: x => x.CommissionId,
                        principalTable: "Commissions",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LawyerJudgments_Commissions_CommissionId",
                        column: x => x.CommissionId,
                        principalTable: "Commissions",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    JudgmentId = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 12, 12, 9, 40, 32, 465, DateTimeKind.Local).AddTicks(7570), 1, "Yargıtay" },
                    { 2, new DateTime(2022, 12, 12, 9, 40, 32, 465, DateTimeKind.Local).AddTicks(7600), 2, "Danıştay" },
                    { 3, new DateTime(2022, 12, 12, 9, 40, 32, 465, DateTimeKind.Local).AddTicks(7600), 3, "Anayasa Mahkemesi" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 12, 12, 9, 40, 32, 452, DateTimeKind.Local).AddTicks(6580), 1, "Onaya Gönderildi" },
                    { 2, new DateTime(2022, 12, 12, 9, 40, 32, 461, DateTimeKind.Local).AddTicks(2040), 2, "Onay Bekliyor" },
                    { 3, new DateTime(2022, 12, 12, 9, 40, 32, 461, DateTimeKind.Local).AddTicks(2060), 3, "Reddedildi" },
                    { 4, new DateTime(2022, 12, 12, 9, 40, 32, 461, DateTimeKind.Local).AddTicks(2070), 4, "Onaylandı" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 12, 12, 9, 40, 32, 464, DateTimeKind.Local).AddTicks(9480), 1, "Avukatın Eklediği Kararlar" },
                    { 2, new DateTime(2022, 12, 12, 9, 40, 32, 464, DateTimeKind.Local).AddTicks(9520), 2, "Yüksek Yargı Kararları" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 12, 12, 9, 40, 32, 463, DateTimeKind.Local).AddTicks(9690), 1, "Avukat-Avukat Stajyeri" },
                    { 2, new DateTime(2022, 12, 12, 9, 40, 32, 463, DateTimeKind.Local).AddTicks(9790), 2, "Öğrenci" },
                    { 3, new DateTime(2022, 12, 12, 9, 40, 32, 463, DateTimeKind.Local).AddTicks(9790), 3, "TBB Kullanıcısı" }
                });
