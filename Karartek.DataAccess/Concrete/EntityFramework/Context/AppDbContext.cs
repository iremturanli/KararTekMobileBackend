...
namespace Karartek.DataAccess.Concrete.EntityFramework.Context
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=KararTek_Deneme;Trusted_Connection=true");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<JudgmentPool>().Property(x => x.DecisionId).IsRequired().HasDefaultValue(false);
            ...
            modelBuilder.Entity<UserLike>().Property(x => x.TypeId).IsRequired();
            modelBuilder.Entity<UserLike>().Property(x => x.JudgmentId).IsRequired();
